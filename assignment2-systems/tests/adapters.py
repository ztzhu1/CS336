...
from cs336_systems import dist_train
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    return dist_train.DDPIndividualParameters(module)
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return dist_train.DDPBucketedParameters(module, bucket_size_mb)
...
def get_sharded_optimizer(
    ...
    """
    return dist_train.ShardedStateOptimizer(params, optimizer_cls, **kwargs)

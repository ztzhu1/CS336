...
from cs336_basics import bpe, nn_336, train
...
def run_linear(
    ...
    """
    linear = nn_336.Linear(d_in, d_out, dtype=weights.dtype)
...
def run_embedding(
    ...
    """
    embedding = nn_336.Embedding(vocab_size, d_model, dtype=weights.dtype)
...
def run_swiglu(
    ...
    swiglu = nn_336.SwiGLU(d_model, d_ff, dtype=w1_weight.dtype)
...
def run_scaled_dot_product_attention(
    ...
    """
    return nn_336.scaled_dot_product_attention(Q, K, V, mask)
...
def run_rope(
    ...
    """
    rope = nn_336.RoPE(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    norm = nn_336.RMSNorm(d_model, eps, dtype=weights.dtype)
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    return nn_336.SiLU()(in_features)
...
def run_get_batch(
    ...
    """
    return train.load_data(dataset, batch_size, context_length, device)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return nn_336.softmax(in_features, dim)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return train.get_lr_cosine_schedule(
